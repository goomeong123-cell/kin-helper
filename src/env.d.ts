...
export interface Api {
  ...
  accounts: {
    ...
    checkProxyIp: (id: number) => Promise<{ ok: boolean; ips?: string[]; distinct?: string[]; stable?: boolean; anonymous?: boolean; leakHeaders?: Array<{ name: string; value: string }>; error?: string }>;
  };
  questions: {
